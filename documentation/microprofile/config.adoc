...
In many instances, in particular for properties not resolved regularly change become visible immediate or faster than the cache duration as they have not been resolved for some seconds already.
