...
The https://github.com/eclipse/microprofile-rest-client/tree/microprofile-rest-client-1.0[Eclipse MicroProfile Rest Client] 
repository contains a number of 
https://github.com/eclipse/microprofile-rest-client/blob/microprofile-rest-client-1.0/spec/src/main/asciidoc/clientexamples.asciidoc[examples] 
and information about how to use this API.

== CDI
Full MicroProfile documentation available https://github.com/eclipse/microprofile-rest-client/blob/microprofile-rest-client-1.0/spec/src/main/asciidoc/cdi.asciidoc[here]
...
== Async
Full MicroProfile documentation available https://github.com/eclipse/microprofile-rest-client/blob/microprofile-rest-client-1.0/spec/src/main/asciidoc/async.asciidoc[here]
...
== Providers
Full MicroProfile documentation available https://github.com/eclipse/microprofile-rest-client/blob/microprofile-rest-client-1.0/spec/src/main/asciidoc/providers.asciidoc[here]
...
See the full https://github.com/eclipse/microprofile-rest-client/blob/microprofile-rest-client-1.0/spec/src/main/asciidoc/providers.asciidoc#provider-declaration[MicroProfile documentation] for the registration methods.
